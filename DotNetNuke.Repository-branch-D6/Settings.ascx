...
<table cellSpacing="0" cellPadding="0" border="0" class="normal">
    ...
    <!-- module description -->
    <tr>
        <td><dnn:label id="plDescription" runat="server" controlname="txtDesktopHTML" suffix=":"></dnn:label></td>
        <td class="repSettingTop"><dnn:texteditor id="teContent" runat="server" Height="250"></dnn:texteditor></td>
    </tr>
    ...
    <tr>
        ...
        <td class="repSetting"><asp:CheckBox ID="cbAllFiles" Runat="server" CssClass="normal" Text="Allow user to view All Files" /></td>
    </tr>
    ...
    <tr>
        ...
        <td class="repSetting"><asp:TextBox ID="txtPageSize" Runat="server" CssClass="normal" Width="50" /></td>
    </tr>

    <tr>
        <td><dnn:label id="plIsPersonal" runat="server" controlname="cbxIsPersonal" suffix=":"></dnn:label></td>
        <td class="repSetting"><asp:CheckBox ID="cbxIsPersonal" runat="server" Checked="false" CssClass="normal" Text="" /></td>
    </tr>
    ...
    <tr>
        ...
        <td class="repSetting">
            ...
            <asp:TextBox ID="txtEmailOnUpload" runat="server" CssClass="normal" Text="" Width="350" />
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="repSetting">
            ...
            <asp:TextBox ID="txtEmailOnComment" runat="server" CssClass="normal" Text="" Width="350" />
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="repSetting">
            <asp:TextBox ID="txtWatermark" Runat="server" CssClass="normal" Width="250"></asp:TextBox>
        </td>
    </tr>
    ...
    <tr id="FileLocationRow1" runat="server" visible="false">
        <td><dnn:label id="plFolders" runat="server" suffix=":"></dnn:label></td>
        <td class="repSetting">&nbsp;</td>
    </tr>

    <tr id="FileLocationRow2" runat="server" visible="false">
        <td><dnn:label id="plApprovedFolder" runat="server" suffix=":"></dnn:label></td>
        <td class="repSetting"><asp:TextBox ID="txtFolderLocation" Runat="server" CssClass="normal" Width="500"></asp:TextBox></td>
    </tr>
    ...
    <tr id="FileLocationRow4" runat="server" visible="false">
        ...
        <td class="repSetting"><asp:TextBox ID="txtPendingLocation" Runat="server" CssClass="normal" Width="500"></asp:TextBox></td>
    </tr>

    <tr id="FileLocationRow5" runat="server" visible="false">
        <td><dnn:label id="plAnonymousFolder" runat="server" suffix=":"></dnn:label></td>
        <td class="repSetting"><asp:TextBox ID="txtAnonymousLocation" Runat="server" CssClass="normal" Width="500"></asp:TextBox></td>
    </tr>
